...
class D2B:
    ...
    def add_equal(self, other):
        ...
        constraints =  [iff(self.get(self.binary_length - i), other.get(other.binary_length - i)) for i in range(1, min_length+1)]
    ...
    def __add__(self, other):
        ...
        for i in range(2,min_length+1):
            ...
            operations.append(iff(Or(And(formula, carry), And(max_len_num.get(max_l - i), min_len_num.get(min_l - i))),new_carry))
            carry = new_carry
