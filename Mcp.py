#!/usr/bin/python3
from models.Cp.model import CpModel, TerminalCpModel
...
def main__legacy(solver_name: 'str' = 'cp', instances_path: 'str' = './instances/', timeout: 'int' = 300,
                 verbose: 'bool' = False, just_time: 'bool' = False):
    solver = None
...
def main(solver_name: 'str' = 'cp', instances_path: 'str' = 'instances/parsed_instances',
         timeout: 'int' = 300000, verbose: 'bool' = False, just_time: 'bool' = False, p: 'int' = 1):
    solver = None
...
def save_instances(solver_name: 'str' = 'cp', instances_load_path: 'str' = './instances/',
                   instances_save_path: 'str' = './instances/parsed/instances/cp'):
...
if __name__ == '__main__':
    ...
    if 'save' in args.keys() is not None:
        save_instances(instances_save_path=args['save'],
                       instances_load_path=args[
                           'instances_path'] if 'instances_path' in args.keys() else './instances/')
    else:
        main(**args)
